...
# plt.plot(time_data_noNaN[1000:1190], flux_data_noNaN[1000:1190],'.', label="Observed Flux", color="black", markersize=8)
plt.errorbar(time_data_noNaN, flux_data_noNaN, yerr=flux_err_noNaN, fmt='o', color='black', ecolor='orange', label="Flux with errors", elinewidth=1, markersize=0.5, capsize=1)
plt.ylabel("Flux [e-/s]",  fontsize=17)
plt.xlabel("Time [days]", fontsize=17)
plt.xticks(fontsize=15)
plt.yticks(fontsize=15)
# plt.title("TESS DATA: HD-209458b")
plt.legend(fontsize=17, loc='center left', markerscale=8)
plt.tight_layout()
plt.show()
...
plt.figure(figsize=(15, 6))
# plt.plot(time_data_noNaN[1000:1190], flux_data_noNaN[1000:1190],'.', label="Observed Flux", color="black", markersize=8)
plt.errorbar(time_data_noNaN[1000:1190], flux_data_noNaN[1000:1190], yerr=flux_err_noNaN[1000:1190], fmt='o', color='black', ecolor='orange', label="Flux with errors", elinewidth=2, markersize=3, capsize=2)
plt.ylabel("Flux [e-/s]",  fontsize=17)
plt.xlabel("Time [days]", fontsize=17)
plt.xticks(fontsize=15)
plt.yticks(fontsize=15)
# plt.title("TESS DATA: HD-209458b")
plt.legend(fontsize=17, loc='center left', markerscale=1.5)
plt.tight_layout()
plt.show()
#%%
...
plt.legend(fontsize=17, loc="lower left", markerscale=3)
plt.show()
...
plt.legend(fontsize=17, loc="lower right", markerscale=3, ncol=2)
plt.show()
