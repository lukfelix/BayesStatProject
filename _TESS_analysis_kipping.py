...
#%%
sample_name = "outputs/mcmc_TESS_samples/samples_kipping_%s_%s_%s_%s.npy" % (mcmc_params['nsteps'], mcmc_params['burn_in_frac'], mcmc_params['nwalkers'], mcmc_params['ndim'])
...
print(np.mean(flat_samples[:,4]), np.std(flat_samples[:,4]))
# %%
