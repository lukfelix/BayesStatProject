...
FINAL_time_data_ = np.load("outputs/data_TESS/FINAL_time_data.npy")
...
fig, ax = plot_single_light_curve_with_zoom(FINAL_time_data_, FINAL_flux_data, FINAL_flux_err_data, plt_size=(20, 10),zoom_range=(1.4, 1.65))
